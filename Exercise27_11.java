...
//    String[] name3 = {"Tom", "Peter"};
        ...
        MyHashSet set1 = new MyHashSet<>(name1);
        MyHashSet set2 = new MyHashSet<>(name2);
...
class MyHashSet<E> implements Collection<E> {
    ...
    public MyHashSet(E[] list) {
        this(list.length * 2, DEFAULT_MAX_LOAD_FACTOR);
    ...
    public boolean containsAll(Collection<?> arg0) {
        ArrayList list = new ArrayList(arg0);
        boolean value = true;
        for (Object e : list) {

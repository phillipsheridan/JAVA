...
public class Project9 {
    ...
    public static void main(String[] args) {
        String[] delta = {"q0 a q1 _ R", "q0 _ q3 _ L", "q0 b q4 b R",
            ...
            "q1 _ q4 _ L", "q2 a q2 a L", "q2 X q2 X L", "q2 _ q0 _ R",
            "q2 b q4 b R"};
        TM tm = new TM(delta, "q0", "q3", "q4");
        tm.run("aabbbb");
    }
}
...
class TM {
    ...
    TM(String[] delta, String q0, String qa, String qr) {
        this.delta = delta;
        this.q0 = q0;
        this.qa = qa;
        this.qr = qr;
    ...
    public void run(String w) {
        ...
        while (true) {
            ...
            String s = map.get(currentState + " "
                    + output.charAt(tapeHead));
            String[] info = s.split(" ");
            ...
            if (direction.equals("L")) {
                if (tapeHead != 0) {
                    ...
                    System.out.println(output.toString());
                    output.delete(tapeHead - 1, tapeHead
                            + nextState.length() - 1);
                } else {
    ...
    public String[] stringSplit(String s) {
        ...
        return new String[]{string1.toString().trim(),

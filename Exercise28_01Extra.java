...
public class Exercise28_01Extra extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        int[][] edges = {
            ...
            {11, 8}, {11, 9}, {11, 10}, {9, 12}, {12, 9}, {8, 12},
            {12, 8},{7,12}, {12,7}
        };
        ...
        primaryStage.setTitle("Exercise28_01Extra"); // Set the stage title
...
interface Displayable {
    ...
    public double getY(); // Get x-coordinate of the vertex
